...
export default function App() {
    ...
    return (_jsx(BrowserRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/register", element: _jsx(RegisterPage, {}) }), _jsx(Route, { element: _jsx(ProtectedRoute, {}), children: _jsxs(Route, { element: _jsx(Layout, {}), children: [_jsx(Route, { path: "/dashboard", element: _jsx(DashboardPage, {}) }), _jsx(Route, { path: "/inbox", element: _jsx(InboxPage, {}) }), _jsx(Route, { path: "/my-memos", element: _jsx(MyMemosPage, {}) }), _jsx(Route, { path: "/memos/:id", element: _jsx(MemoDetailPage, {}) }), _jsx(Route, { path: "/memos/create", element: _jsx(MemoCreatePage, {}) }), _jsx(Route, { path: "/admin", element: _jsx(AdminPage, {}) })] }) }), _jsx(Route, { path: "/", element: _jsx(Navigate, { to: token ? '/dashboard' : '/login' }) })] }) }));
}
