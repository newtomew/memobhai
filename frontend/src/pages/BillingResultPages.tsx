    ...
    <div className="min-h-screen bg-landing-bg flex items-center justify-center p-6">
      <div className="max-w-md w-full rounded-3xl border border-landing-border bg-landing-card p-8 text-center">
        ...
        <div className="flex flex-col gap-2">
          <Link to="/billing" className="bg-accent text-charcoal font-semibold py-3 rounded-full">Go to Billing</Link>
  ...
  return (
    <div className="min-h-screen bg-landing-bg flex items-center justify-center p-6">
      <div className="max-w-md w-full rounded-3xl border border-landing-border bg-landing-card p-8 text-center">
        ...
        <Link to="/billing" className="bg-accent text-charcoal font-semibold py-3 px-6 rounded-full inline-block">Try again</Link>
      </div>
    </div>
  );
}
